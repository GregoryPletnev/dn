...
bin/unittests: tests/unittests.pas src/dnscreen.pas src/dnpanel.pas src/dnfileops.pas src/dnvfs.pas src/dnuu.pas src/dnsession.pas src/dnoptions.pas src/dnusermenu.pas src/dnhighlite.pas
	@mkdir -p bin $(UNITDIR)
